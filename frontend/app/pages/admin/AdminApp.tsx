...
export default function AdminApp() {
  ...
  const t=useT();
  const titles: Record<string,string> = {stats:t("menu.stats"),users:t("menu.users"),identities:t("menu.identities"),templates:t("menu.templates"),test:t("menu.test"),settings:t("menu.settings"),sql:"SQL",logs:t("menu.logs")||"Logs"};
  return <div className="min-h-screen flex">
    <Sidebar menus={[{id:"stats",icon:"📊",label:t("menu.stats")},{id:"users",icon:"👤",label:t("menu.users")},{id:"identities",icon:"🔐",label:t("menu.identities")},{id:"templates",icon:"📋",label:t("menu.templates")},{id:"test",icon:"📧",label:t("menu.test")},{id:"settings",icon:"⚙️",label:t("menu.settings")},{id:"sql",icon:"🗄️",label:"SQL"},{id:"logs",icon:"📄",label:t("menu.logs")||"Logs"}]} active={tab} setActive={setTab}/>
