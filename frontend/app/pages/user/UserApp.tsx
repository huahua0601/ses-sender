...
export default function UserApp() {
  ...
  const titles: Record<string,string> = {groups:"客群管理",templates:"邮件模版",send:"批量发送",history:"发送历史",details:"邮件明细",unsub:"退订管理"};
  return <div className="min-h-screen flex">
    <Sidebar menus={[{id:"groups",icon:"📁",label:"客群管理"},{id:"templates",icon:"📋",label:"邮件模版"},{id:"send",icon:"🚀",label:"批量发送"},{id:"history",icon:"📊",label:"发送历史"},{id:"details",icon:"📧",label:"邮件明细"},{id:"unsub",icon:"🚫",label:"退订管理"}]} active={tab} setActive={setTab}/>
